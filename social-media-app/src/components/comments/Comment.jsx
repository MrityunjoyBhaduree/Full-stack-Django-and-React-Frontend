...
function Comment(props) {
    ...
    const handleLikeClick = (action) => {
        axiosService
        .post(`${API_VERSION}/post/${postId}/comment/${comment.id}/${action}/`)
        .then(()=> {
            refresh();
        })
    ...
    const handleDelete = () => {
        // Handle the deletion of comment
        axiosService
        .delete(`${API_VERSION}/post/${postId}/comment/${comment.id}/`)
        .then(() => {
            setToaster({
                type: "danger",
